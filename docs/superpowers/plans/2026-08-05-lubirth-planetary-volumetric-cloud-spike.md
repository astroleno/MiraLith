...
> 2026-08-09 opening-only Task 2O supersession：当前产品 gate 不再由 `2.5 / 50 / 200 km` 近景决定；这些视角和上述 `VIEW_SPACE_ACCEPTANCE_CONTRACT_FAIL` 只保留为未来低空镜头诊断。commit `b135e75` 在真实 opening progress `0.00 / 0.06 / 0.12 / 0.18` 上完成 shape `220 / 260 / 300 km` × detail `30 / 40 km` 的 96 帧正式矩阵。shape/detail 已投影到 `20.814–29.182 px / 2.838–3.891 px`，但六组 full output 仍是贴地平板、缺少 base/core/top 和稳定 BSM 自阴影，全部视觉 `FAIL`。当前权威 checkpoint 为 `OPENING_MORPHOLOGY_VISUAL_FAIL`；Task 3–6、Task 0P 与原 Task 0–8 继续锁定，且不得继续水平 repeat 搜索。详见 `docs/lubirth-planetary-cloud-evidence/2026-08-09/v3-opening-morphology/`。
> 计划日期：2026-08-05。
