...
function updatePhysicalScaleUniforms(
  ...
  material.uniforms.atmosphereRadius.value =
    planetRadius * (referenceLook ? 1.026 : ATMOSPHERE_RADIUS_RATIO);
  ...
  material.uniforms.sunIntensity.value = referenceLook
    ? (emphasis ? 13.2 : 8.6) * Math.max(composition.atmosphere.intensity, 0)
  ...
  material.uniforms.limbWhiteStrength.value = referenceLook ? (emphasis ? 0.024 : 0.012) : 0.46;
  material.uniforms.limbBlueStrength.value = referenceLook ? (emphasis ? 0.86 : 0.76) : 0.78;
  material.uniforms.limbShelfStrength.value = referenceLook ? (emphasis ? 0.52 : 0.44) : 0.54;
}
